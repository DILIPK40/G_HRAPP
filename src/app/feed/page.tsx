...
const mockFeedItems: CompanyPost[] = [
  ...
  },
  {
  ...
  },
   {
    ...
    content: "Get your creative hats on! The annual Innovation Challenge is now live. Submit your ideas by end of month.",
  ...
  return (
    <div className="container mx-auto py-8">
      <header className="mb-8">
        ...
        <p className="text-muted-foreground">Stay updated with the latest news and announcements from across the company.</p>
      </header>
          ...
          <Card key={item.id} className="flex flex-col overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
            {item.imageUrl && (
              <div className="relative h-48 w-full">
                <Image 
                  ...
                  layout="fill" 
                  objectFit="cover" 
                  data-ai-hint={item.category === "Announcement" ? "city building" : "team collaboration"}
                />
              </div>
            )}
            <CardHeader>
            ...
            <CardFooter className="flex items-center gap-2 border-t pt-4 mt-auto">
              <Avatar className="h-8 w-8">
                <AvatarImage src={`https://placehold.co/40x40.png?text=${item.author.substring(0,1)}`} data-ai-hint="person photo"/>
